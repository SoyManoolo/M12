...
const adminToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImI0YWU5Y2I4LTBjOWYtNGYxZS04NDY2LWNiOGNlYWE2ZmI3MyIsInVzZXJuYW1lIjoiYWRtaW4iLCJpYXQiOjE3NDgxNzA3NTUsImV4cCI6MTc0ODE3NDM1NX0.GzgT0DE1HpFlEIf8854tyGJS5o8ocRUZY9LtkzzuxkQ";
const testUserToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjM5ODM3ZTlkLThjYjItNDg2YS05MDJkLWE4MTBjYTg1MmEyMyIsInVzZXJuYW1lIjoidGVzdHVzZXIiLCJpYXQiOjE3NDgxNzA3MzcsImV4cCI6MTc0ODE3NDMzN30.LDh88Uq49jx-4akAcAiPBn4eLhfqFpJ6e";
...
adminSocket.on("connect", () => {
    ...
    adminSocket.emit("join-user", adminId);
});
...
testUserSocket.on("connect", () => {
    ...
    testUserSocket.emit("join-user", testUserId);
});
